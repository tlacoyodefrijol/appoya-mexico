...
var schemaEnrollment = new Schema({
    ...
    role: {type: String, enum: ['supervisor', 'volunteer']}, // Qué rol tomará el usuario en esta inscripción
    event: {type:Schema.Types.ObjectId, ref:'Event'}, // A qué grupo ss inscribe al usuario
